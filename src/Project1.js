                    ...
                    <div className="wrapper">
                        ...
                        <header>
                            ...
                            <div className="share">
                                ...
                                <awesome-button className="s_" title="Share it on Twitter" type="twitter" size="icon" via="warrengfoofight" text="Fantasy Football Rankings Editor | UI/UX Javascript Specialist | Warren Peterson" sharer="">
