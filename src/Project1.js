        ...
        <div>
            ...
            <div class="content pages" id="portfolio">
                <article itemscope="" itemtype="https://schema.org/WebSite" class="centered">
                    <div class="wrapper">
                        <header>
                            <h1 itemprop="name">Project 1 </h1>
                            <h2 itemprop="description">Project 1 is a fun application</h2>
                            <link itemprop="image" href="https://warrenpetersonportfolio.com/images/portfolio/sky-go-desktop/web.png"/>
                            <meta itemprop="url" content="https://www.project1.com/watch/project-1"/>
                            ...
                            <div class="share">
                                ...
                                <awesome-button color="teal" type="external" target="_blank" href="https://www.project1.com/watch/project-1" title="Visit the website">
                                ...
                                <awesome-button class="s_" title="Share it on Twitter" type="twitter" size="icon" via="rcaferati" text="Project 1 | UI/UX Javascript Specialist | Warren Peterson" sharer="">
                        ...
                        <div class="text">
                            <div class="section">
                                ...
                                <hr/>
                                <p>Project developed as a dude writing code and will put more information here.</p>
                            ...
                            <div class="section">
                                <h2>Resources</h2><hr/>
                                <ul>
                                    <li>Download the app at <span class="fancy"><a target="_blank" title="Project 1 Website" href="https://www.project1.com/watch/project-1">https://www.project1.com/watch/project-1o</a></span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="disqus">
