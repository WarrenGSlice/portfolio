    ...
    <section className="current">
        <div>
            <div className="page-control">
                ...
                <a href="/project9" className="next">
                    <span>UNO</span>
                    <em></em>
                </a>
                
                <a href="/project7" className="prev">
            ...
            <div className="content pages" id="portfolio">
                <article itemScope="" itemType="https://schema.org/WebSite" className="centered">
                    <div className="wrapper">
                        <header>
                            <h1 itemProp="name">Warren Blog</h1>
                            <h2 itemProp="description">Blogging Application built using PHP with MySQL </h2>
                            <link itemProp="image" href="https://i.imgur.com/lIezQfb.png"/>
                            <meta itemProp="url" content="https://www.loom.com/share/b956f9875cda40bfa1ce3bfbbf42ef85"/>
                            ...
                            <div className="share">
                                <awesome-button  type="external" target="_blank" href="https://www.loom.com/share/b956f9875cda40bfa1ce3bfbbf42ef85" title="Watch video">
                                    <a href="https://www.loom.com/share/b956f9875cda40bfa1ce3bfbbf42ef85" className="aws-btn aws-btn--external aws-btn--orange aws-btn--visible">
                                ...
                                <awesome-button className="s_" title="Share it on Twitter" type="twitter" size="icon" via="warrengfoofight" text="Warren Blog | Software Developer | Warren Peterson" sharer="">
                        ...
                        <div className="media">
                            ...
                            <small>
                                <a target="_blank" className="hidden" href="https://github.com/WarrenGSlice/Final-Project">Source Code</a>.
                            </small>
                            <AwesomeSlider  height="x58%" bullets="true" animation="cubeAnimation">
                                <item source="https://i.imgur.com/lIezQfb.png" style={{height:"100%", marginTop:"0.0%" }}></item>
                                <item source="https://i.imgur.com/JaLooju.png" style={{height:"100%", marginTop:"0%" }}></item>
                                <item source="https://i.imgur.com/PzKtxcG.png" style={{height:"94%", marginTop:"1.5%" }}></item>
                                <item source="https://i.imgur.com/bQAPYDp.png" style={{height:"78%", marginTop:"6%" }}></item>
                                
                                <item source="https://i.imgur.com/pgBdDpx.png" style={{height:"78%", marginTop:"5.5%" }}></item>
                                <item source="https://i.imgur.com/Y6wOSz0.png" style={{height:"78%", marginTop:"5.5%" }}></item>
                                <item source="https://i.imgur.com/xNVlaJa.png" style={{height:"78%", marginTop:"5.5%" }}></item>
                                <item source="https://i.imgur.com/0yhvaFA.png" style={{height:"100%", marginTop:"0%" }}></item>
                            </AwesomeSlider>
                        </div>
                        <div className="text">
                        <div className="section">
                                ...
                                <hr/>
                                <p>Blogging web application where people can create accounts to post and edit blogs. Created using <strong>PHP, HTML, CSS, JavaScript, and MySQL.</strong>
                                </p>
                                <p>Blog post are restricted by user roles. Admins have access to all blog posts and normal users can only access their own blog posts. Uses 
                                    advanced security procedures.
                                </p>
                                <p>This application is no longer deployed, but can be viewed at:  
                                    <span className="fancy">
                                        <a href="https://www.loom.com/share/b956f9875cda40bfa1ce3bfbbf42ef85">_Video Link</a>
                                    </span>
                                </p>
                                <p>
                                    This was one of the first applications that I built. It uses a lot of basic PHP combined with SQL to handle all of the queries. It's not the
                                     best looking applicaiton, but it worked well. At one time it was deployed to <strong>Azure Cloud</strong>, but I had to remove it because the
                                     fees were adding up fast. 
                                </p>
                            </div>
                            <div className="section">
                            ...
                            <div className="section">
                                ...
                                <ul>
                                    <li>Download the Full-Stack source code at  
                                        <span className="fancy">
                                            <a target="_blank" title="Warren Blog" href="https://github.com/WarrenGSlice/Final-Project?tab=readme-ov-file">  _Source Code Link</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
