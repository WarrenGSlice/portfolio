        ...
        <div>
            ...
            <div class="content pages" id="portfolio">
                <article itemscope="" itemtype="https://schema.org/WebSite" class="centered">
                    <div class="wrapper">
                        <header>
                            <h1 itemprop="name">Project 6 </h1>
                            <h2 itemprop="description">Project 6 is a fun application</h2>
                            <link itemprop="image" href="https://warrenpetersonportfolio.com/images/portfolio/sky-go-desktop/web.png"/>
                            <meta itemprop="url" content="https://www.project6.com/watch/project6"/>
                            ...
                            <div class="share">
                                ...
                                <awesome-button color="teal" type="external" target="_blank" href="https://www.project6.com/watch/project6" title="Visit the website">
                                ...
                                <awesome-button class="s_" title="Share it on Twitter" type="twitter" size="icon" via="rcaferati" text="Project 6 | UI/UX Javascript Specialist | Warren Peterson" sharer="">
                        ...
                        <div class="text">
                            ...
                            <div class="section">
                                <h2>Resources</h2><hr/>
                                <ul>
                                    <li>Download the app at <span class="fancy"><a target="_blank" title="Project 6" href="https://www.project6.com/watch/project6">https://www.project6.com/watch/project6</a></span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="disqus">
