    ...
    <section class="current">
        <div>
            <div class="page-control">
                ...
                <a href="/project3" class="next">
                    <span>Project 3</span>
                    <em></em>
                </a>
                
                <a href="/project1" class="prev">
                    <span>Project 1</span>
                    <em></em>
                </a>
                <div class="ribbon">
            ...
            <div class="content pages" id="portfolio">
                <article itemscope="" itemtype="https://schema.org/WebSite" class="centered">
                    <div class="wrapper">
                        <header>
                            <h1 itemprop="name">Project 2 </h1>
                            <h2 itemprop="description">Project 2 is a fun application</h2>
                            <link itemprop="image" href="https://warrenpetersonportfolio.com/images/portfolio/sky-go-desktop/web.png"/>
                            <meta itemprop="url" content="https://www.project2.com/watch/project2"/>
                            ...
                            <div class="share">
                                ...
                                <awesome-button color="teal" type="external" target="_blank" href="https://www.project2.com/watch/project2" title="Visit the website">
                                ...
                                <awesome-button class="s_" title="Share it on Twitter" type="twitter" size="icon" via="rcaferati" text="Project 2 | UI/UX Javascript Specialist | Warren Peterson" sharer="">
                        ...
                        <div class="text">
                            <div class="section">
                                ...
                                <hr/>
                                <p>Project developed as a contractor app is a React web application build on top of the framework.</p>
                            ...
                            <div class="section">
                                <h2>Resources</h2><hr/>
                                <ul>
                                    <li>Download the app at <span class="fancy"><a target="_blank" title="Project 2" href="https://www.project2.com/watch/project2">https://www.project2.com/watch/project2</a></span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="disqus">
