    ...
    <section className="current">
        <div>
            <div className="page-control">
                ...
                <a href="/project6" className="next">
            ...
            <div id="stars"></div>
                <article itemScope="" itemType="https://schema.org/WebSite" className="centered">
                    <div className="wrapper">
                        <header>
                            <h1 itemProp="name">Maze Solver</h1>
                            <h2 itemProp="description">Implements stack and queue DFS data structure to find a path through a maze using C++ on a Console Application</h2>
                            <link itemProp="image" href="https://i.imgur.com/viiUSry.png"/>
                            <meta itemProp="url" content="https://www.loom.com/share/7b6c50dae35c4275bbaab1c87d01d28d"/>
                            ...
                            <div className="share">
                                <awesome-button  type="external" target="_blank" href="https://www.loom.com/share/7b6c50dae35c4275bbaab1c87d01d28d" title="View The Project">
                                    <a href="https://www.loom.com/share/7b6c50dae35c4275bbaab1c87d01d28d" className="aws-btn aws-btn--external aws-btn--orange aws-btn--visible">
                                ...
                                <awesome-button className="s_" title="Share it on Twitter" type="twitter" size="icon" via="warrengfoofight" text="Maze Solver | Software Developer | Warren Peterson" sharer="">
                        ...
                        <div className="media">
                            ...
                            <small>
                                <a target="_blank" className="hidden" href="https://www.loom.com/share/7b6c50dae35c4275bbaab1c87d01d28d">Loom Video</a>.
                            </small>
                            <AwesomeSlider  height="x58%" bullets="true" animation="cubeAnimation">
                                <item source="https://i.imgur.com/viiUSry.png" style={{height:"95%", marginTop:"1.6%" }}></item>
                                <item source="https://i.imgur.com/WCHMXjF.png" style={{height:"86%", marginTop:"4.2%" }}></item>
                            </AwesomeSlider>
                        </div>
                        <div className="text">
                            <div className="section">
                                ...
                                <hr/>
                                <p>The idea behind this project was to create a basic stack and queue algorithm that could find the shortest path through a maze. This is a simple
                                     console application ran on Visual Studio
                                </p>
                                <p>I used <strong>C++</strong> to write the code. The code uses a <strong>DFS - Depth First Search</strong> backtracking algorithm to determine the correct path.
                                </p>
                            </div>
                            <div className="section">
                            ...
                            <div className="section">
                                <h2>Resources</h2><hr/>
                                <ul>
                                    <li>View the Algorithm in action at:   
                                        <span className="fancy">
                                            <a target="_blank" title="Portfolio" href="https://www.loom.com/share/7b6c50dae35c4275bbaab1c87d01d28d">  _Video Link</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
