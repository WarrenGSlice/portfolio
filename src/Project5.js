    ...
    <section class="current">
        <div>
            <div class="page-control">
                ...
                <a href="/project6" class="next">
                    <span>Project 6</span>
                    <em></em>
                </a>
                
                <a href="/project4" class="prev">
                    <span>Project4</span>
                    <em></em>
                </a>
                <div class="ribbon">
            ...
            <div class="content pages" id="portfolio">
                <article itemscope="" itemtype="https://schema.org/WebSite" class="centered">
                    <div class="wrapper">
                        <header>
                            <h1 itemprop="name">Project 5 </h1>
                            <h2 itemprop="description">Project 5 is a fun application</h2>
                        ...
                        <div class="text">
                            <div class="section">
                                ...
                                <hr/>
                                <p>Project developed as a contractor app is a React web application build on top of the Electron framework.</p>
                            ...
                            <div class="section">
                                <h2>Resources</h2><hr/>
                                <ul>
                                    <li>Download the app at <span class="fancy"><a target="_blank" title="Project 5" href="https://www.project5.com/watch/project5">https://www.project5.com/watch/project5</a></span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="disqus">
