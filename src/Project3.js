    ...
    <section class="current">
        <div>
            <div class="page-control">
                ...
                <a href="/project4" class="next">
                    <span>Project 4</span>
                    <em></em>
                </a>
                
                <a href="/project2" class="prev">
                    <span>Project 2</span>
                    <em></em>
                </a>
                <div class="ribbon">
            ...
            <div class="content pages" id="portfolio">
                <article itemscope="" itemtype="https://schema.org/WebSite" class="centered">
                    <div class="wrapper">
                        <header>
                            <h1 itemprop="name">Project 3 </h1>
                            <h2 itemprop="description">Project 3 is a fun application</h2>
                            <link itemprop="image" href="https://warrenpetersonportfolio.com/images/portfolio/sky-go-desktop/web.png"/>
                            <meta itemprop="url" content="https://www.project3.com/watch/project3"/>
                            ...
                            <div class="share">
                                ...
                                <awesome-button color="teal" type="external" target="_blank" href="https://www.project3.com/watch/project3" title="Visit the website">
                        ...
                        <div class="text">
                            ...
                            <div class="section">
                                <h2>Resources</h2><hr/>
                                <ul>
                                    <li>Download the app at <span class="fancy"><a target="_blank" title="Project 3" href="https://www.project3.com/watch/project3">https://www.project3.com/watch/project3</a></span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="disqus">
