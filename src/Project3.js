                    ...
                    <div className="wrapper">
                        <header>
                            ...
                            <div className="share">
                                ...
                                <awesome-button className="s_" title="Share it on Twitter" type="twitter" size="icon" via="warrengfoofight" text="Shoe Fly Order Management Web Application | UI/UX Javascript Specialist | Warren Peterson" sharer="">
