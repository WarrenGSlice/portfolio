                    ...
                    <div className="wrapper">
                        <header>
                            ...
                            <div className="share">
                                ...
                                <awesome-button className="s_" title="Share it on Twitter" type="twitter" size="icon" via="warrengfoofight" text="Minesweeper | Software Developer | Warren Peterson" sharer="">
