    ...
    <section class="current">
        <div>
            <div class="page-control">
                ...
                <a href="/project8" class="next">
                    <span>Project 8</span>
                    <em></em>
                </a>
                
                <a href="/project6" class="prev">
                    <span>Project 6</span>
                    <em></em>
                </a>
                <div class="ribbon">
            ...
            <div class="content pages" id="portfolio">
                <article itemscope="" itemtype="https://schema.org/WebSite" class="centered">
                    <div class="wrapper">
                        <header>
                            <h1 itemprop="name">Project 7 </h1>
                            <h2 itemprop="description">Project 7 is a fun application</h2>
                            <link itemprop="image" href="https://warrenpetersonportfolio.com/images/portfolio/sky-go-desktop/web.png"/>
                            <meta itemprop="url" content="https://www.project7.com/watch/project7"/>
                            ...
                            <div class="share">
                                ...
                                <awesome-button color="teal" type="external" target="_blank" href="https://www.project7.com/watch/project7" title="Visit the website">
                                ...
                                <awesome-button class="s_" title="Share it on Twitter" type="twitter" size="icon" via="rcaferati" text="Project 7 | UI/UX Javascript Specialist | Warren Peterson" sharer="">
                        ...
                        <div class="text">
                            ...
                            <div class="section">
                                <h2>Resources</h2><hr/>
                                <ul>
                                    <li>Download the app at <span class="fancy"><a target="_blank" title="Project 7" href="https://www.project7.com/watch/project7">https://www.project7.com/watch/project7</a></span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="disqus">
